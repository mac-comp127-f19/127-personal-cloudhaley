...
//        One way to do it
//        int itemNum = 1;
//        List<String> result = new ArrayList<>(items.size()); //items.size() is optional, but it helps make it faster
...
//      Second way to do it below, based on Wednesday 9/18 reading
